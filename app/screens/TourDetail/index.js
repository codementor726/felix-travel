...
export default class TourDetail extends Component {
  ...
  _renderScene = ({ route, jumpTo }) => {
    switch (route.key) {
      ...
      case "tour":
        return <TourTab jumpTo={jumpTo} navigation={this.props.navigation} />;
      case "package":
        return (
          <PackageTab jumpTo={jumpTo} navigation={this.props.navigation} />
        );
      case "review":
      ...
      <ScrollView>
        <View style={{ paddingHorizontal: 20 }}>
          <Text body2 style={{ marginTop: 20 }}>
            ...
            small villages and big cities. There's lots to choose from in over
            50 independent states. Our Europe multi-country tours are some of
            the best packages. We offer you great prices, quality and
            convenience. Get ready for the best European vacation! Europe has a
            list of possible adventures for everyone.{" "}
          </Text>
          <PackageItem
