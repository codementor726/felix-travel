...
export default class Profile2 extends Component {
  ...
  _renderScene = ({ route, jumpTo }) => {
    switch (route.key) {
      case "booking":
        return (
          <BookingTab jumpTo={jumpTo} navigation={this.props.navigation} />
        );
      case "profile":
        return (
      ...
      case "setting":
        return (
          <SettingTab jumpTo={jumpTo} navigation={this.props.navigation} />
        );
      case "activity":
        return (
          <ActivityTab jumpTo={jumpTo} navigation={this.props.navigation} />
        );
    }
  };
