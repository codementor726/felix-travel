...
export default class CruiseDetail extends Component {
  ...
  _renderScene = ({ route, jumpTo }) => {
    switch (route.key) {
      case "information":
        return (
          <InformationTab jumpTo={jumpTo} navigation={this.props.navigation} />
        );
      case "itinerary":
        return <Itinerary jumpTo={jumpTo} navigation={this.props.navigation} />;
      case "feedback":
        return <Feedback jumpTo={jumpTo} navigation={this.props.navigation} />;
      case "review":
        return <ReviewTab jumpTo={jumpTo} navigation={this.props.navigation} />;
    }
  };
    ...
    return (
      <View style={{ paddingHorizontal: 20 }}>
        <Text body2 style={{ marginTop: 15 }}>
          ...
          Alaska cruise a remarkable experience. Venture into the wilderness on
          a dogsled ride in Juneau, witness Misty Fjords aboard a jet-powered
          catamaran in Ketchikan, and take it all in via the rails on the
        ...
        <View style={{ paddingVertical: 15 }}>
          ...
          <View style={styles.itemReason}>
            ...
            <View style={{ marginLeft: 10 }}>
              ...
              <Text body2>
                Lorem ipsum dolor sit amet, nec et suas augue diceret, cu cum
                malis veniam democritum. Eu liber vocibus his, qui id cetero
              </Text>
            </View>
          </View>
          <View style={styles.itemReason}>
            <Icon name="pagelines" size={18} color={BaseColor.accentColor} />
            <View style={{ marginLeft: 10 }}>
              <Text subhead semibold>
                Great Food
              </Text>
          ...
          <View style={styles.itemReason}>
            <Icon name="servicestack" size={18} color={BaseColor.accentColor} />
            <View style={{ marginLeft: 10 }}>
              <Text subhead semibold>
                Private Beach
              </Text>
  ...
  render() {
    ...
    return (
      <View style={{ alignItems: "center", padding: 20 }}>
        ...
        />
        <TextInput
          style={[BaseStyle.textInput, { marginTop: 20, height: 140 }]}
