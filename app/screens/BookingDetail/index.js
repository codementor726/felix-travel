...
export default class BookingDetail extends Component {
  ...
  _renderScene = ({ route, jumpTo }) => {
    switch (route.key) {
      case "preview":
        return (
          <PreviewTab jumpTo={jumpTo} navigation={this.props.navigation} />
        );
      case "confirm":
        return (
          <ConfirmTab jumpTo={jumpTo} navigation={this.props.navigation} />
        );
      case "complete":
        return (
          <CompleteTab jumpTo={jumpTo} navigation={this.props.navigation} />
        );
      case "detail":
        return <DetailTab jumpTo={jumpTo} navigation={this.props.navigation} />;
    }
  };
